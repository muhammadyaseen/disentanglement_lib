...
def get_datasets():
    ...
    all_datasets = h.chainit([
        config_shapes3d_size_azimuth, config_shapes3d_objcolor_azimuth, config_shapes3d_objcolor_objsize
    ])
...
class CorrelatedFactorsStudyWSID1(study.Study):
    ...
    def get_model_config(self, model_num=0):
        ...
        model_config_file = resources.get_file(
            "config/correlated_factors_study_ws_id1/model_configs/shared.gin")
    ...
    def get_postprocess_config_files(self):
        ...
        return list(
            resources.get_files_in_folder(
                "config/correlated_factors_study_ws_id1/postprocess_configs/"))

    def get_eval_config_files(self):
        """Returns evaluation config files."""
        return list(
            resources.get_files_in_folder(
                "config/correlated_factors_study_ws_id1/metric_configs/"))
